...
@SourceType(value = "DataRobotARP", label = "DataRobot",uiConfig = "datarobot-layout.json")
public class DataRobotConf extends AbstractArpConf<DataRobotConf> {
  private static final String ARP_FILENAME = "arp/implementation/datarobot-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.datarobot.DataRobotDriver";
